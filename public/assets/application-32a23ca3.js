  ...
  var multiplayer_fruitbox_controller_default = class extends Controller {
    ...
    showHints() {
      ...
      if (solutions.length === 0) {
        console.log("No moves available, requesting new board");
    ...
    async requestNewBoard() {
      try {
        ...
        console.error("Error requesting new board:", error2);
      }
    }
    showNewBoardMessage() {
      let messageElement = document.getElementById("new-board-message");
    ...
    showQueuedBoardMessage() {
      ...
      messageElement.textContent = "No more moves! Waiting for other player to finish current board... \u23F3";
    ...
    pollForNewBoard() {
      this.boardPollInterval = setInterval(async () => {
        try {
          ...
          console.error("Error polling for new board:", error2);
        }
      }, 2e3);
    }
    testConnection() {
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-0154a881.js.map
