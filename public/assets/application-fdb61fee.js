...
%o`, message, error2, detail);
  ...
  var fruitbox_controller_default = class extends Controller {
    ...
    testConnection() {
      console.log("Stimulus test method called!");
    ...
    initializeGame() {
      ...
      this.renderBoard();
      this.updateTimer();
      console.log("Game initialized, timer should show 01:30");
    }
    generateBoard() {
      this.board = [];
      for (let i = 0; i < 10; i++) {
    ...
    checkAndDestroySelection() {
      console.log("checkAndDestroySelection called");
      const minRow = Math.min(this.startRow, this.endRow);
      const maxRow = Math.max(this.startRow, this.endRow);
      const minCol = Math.min(this.startCol, this.endCol);
      const maxCol = Math.max(this.startCol, this.endCol);
      ...
      console.log("Selection sum:", sum, "selectedTiles:", selectedTiles.length);
      if (sum === 10 && selectedTiles.length > 0) {
        console.log("Valid move detected! Timer started:", this.timerStarted);
        if (!this.timerStarted) {
          console.log("First successful move - starting timer!");
          this.startTimer();
        }
    ...
    startTimer() {
      ...
      console.log("Game timer interval set:", this.timerInterval);
    }
    updateTimer() {
      const timerElement = document.getElementById("timer");
      if (timerElement) {
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-23a47820.js.map
